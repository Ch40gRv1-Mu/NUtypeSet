...
\begin{center}
    {\Huge \scshape Nutypeset Mu Tu} \\ \vspace{1pt}
    27 Prince George's Park, National University of Singapore, Singapore 118425 \\ 
 \vspace{1pt}
\small \raisebox{-0.1\height}\faPhone\ 8888 ~ \href{mailto:test@u.nus.edu}{\raisebox{-0.2\height}\faEnvelope\  \underline{test@u.nus.edu}}
    \vspace{-8pt}
\end{center}
