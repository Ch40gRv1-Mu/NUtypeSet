...
\begin{center}
    {\Huge \scshape Nutypeset test} \\ \vspace{1pt}
    27 Prince George's Park, National University of Singapore, Singapore 118425 \\ 
 \vspace{1pt}
\small \raisebox{-0.1\height}\faPhone\ 88889999 ~ \href{mailto:nutypeset@u.nus.edu}{\raisebox{-0.2\height}\faEnvelope\  \underline{nutypeset@u.nus.edu}}
    \vspace{-8pt}
\end{center}
